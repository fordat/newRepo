...
/* package encryptichat-0.1.0.0 */
#ifndef VERSION_encryptichat
#define VERSION_encryptichat "0.1.0.0"
#endif /* VERSION_encryptichat */
#ifndef MIN_VERSION_encryptichat
#define MIN_VERSION_encryptichat(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_encryptichat */
...
#define CURRENT_COMPONENT_ID "encryptichat-0.1.0.0-F1UnnnhACTG58mNSnGXbdl-encryptichat"
